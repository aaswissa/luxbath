...
<div class="container-fluid">
                    ...
                    <div id="filter-categories" class="collapse show">
                      <div class="card-body pt-0">
                        <ul class="list-tree metismenu">
                          <li class="mm-active">
                            <a href="{{ url('shop/' . $category['curl']) }}" class="" aria-expanded="true">{{ $category['ctitle']}} </a>
    ...
    <div class="col-md-8 align-self-center">
      <br><br>
            <h4 class="card-title font-weight-normal mb-3">{{$item['ptitle']}}</h4>
            ...
            <div class="form-row">
              ...
              @if (! Cart::get($item['id']))
              <input data-pid="{{$item['id']}}" type="button" class="btn btn-faded-primary add-to-cart-btn" value="Add to Cart"> 
              @else
              <input disabled="disabled" type="button" class="btn btn-faded-primary add-to-cart-btn" value="Added to Cart">
              @endif
              <a href="{{url('shop/cart')}}" class="btn btn-faded-success ml-3">View Cart</a>
            ...
            <p>{!! $item['particle'] !!}</p>
              <!-- <div class="form-group">
                ...
                <div class="btn-group btn-group-sm btn-group-toggle btn-group-circle" data-toggle="buttons">
                  <label class="btn btn-outline-secondary" data-toggle="tooltip" title="" data-original-title="Small">
                    <input type="radio" name="productSize">S
                  </label>
                  <label class="btn btn-outline-secondary active" data-toggle="tooltip" title="" data-original-title="Medium">
                    <input type="radio" name="productSize" checked="">M
                  </label>
                  <label class="btn btn-outline-secondary" data-toggle="tooltip" title="" data-original-title="Large">
                    <input type="radio" name="productSize">L
                  </label>
                  <label class="btn btn-outline-secondary" data-toggle="tooltip" title="" data-original-title="Extra Large">
                    <input type="radio" name="productSize">XL
                  </label>
                </div>
              </div> -->
              <img src="{{asset('images/'. $item['pimage'])}}" data-large="{{asset('images/'. $item['pimage'])}}" alt="Product" class="swiper-slide swiper-slide-active" style="width: 494px;">
                           <!-- <div class="form-group">
