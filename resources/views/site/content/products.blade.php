                    ...
                    <div id="filter-categories" class="collapse show">
                      <div class="card-body pt-0">
                        <ul class="list-tree metismenu">
                          <li class="mm-active">
                            <a href="{{ url()->current() . '/desc'}}" class="" aria-expanded="true"> <i class="fas fa-sort-amount-up"></i> High to Low </a> <!-- <small class="text-muted">(120)</small> -->
                            <ul class="mm-collapse mm-show">
                            </ul>
                          </li>
                  
                          <li class="mm-active mt-3">
                            <a href="{{ url()->current() . '/asc'}}" class="" aria-expanded="true"> <i class="fas fa-sort-amount-down"></i> Low to High </a> <!-- <small class="text-muted">(120)</small> -->
                            <ul class="mm-collapse mm-show">
                            </ul>
                          </li>
                          <!-- <li>
