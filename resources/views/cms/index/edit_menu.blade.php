...
<div class="row">
  <div class="col-8">
    ...
    <div class="form-group">
        ...
        <input value="{{$menu_item['murl']}}" type="text" name="url" id="url" class="form-control field-input-cms target-text">
    ...
    <div class="form-group">
        ...
        <input value="{{$menu_item['mtitle']}}" type="text" name="title" id="title" class="form-control field-input-cms">
      ...
      <input class="btn btn-primary" type="submit" name="submit" value="Update Menu">
