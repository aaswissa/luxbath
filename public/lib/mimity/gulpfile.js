...
function pluginsTask() {
  return all(
    ...
    // Swiper
    src(['node_modules/swiper/dist/css/swiper.css', 'node_modules/swiper/dist/css/swiper.min.css']).pipe(dest(`${pluginsFolder}/swiper`)),
    src(['node_modules/swiper/dist/js/swiper.js', 'node_modules/swiper/dist/js/swiper.min.js']).pipe(dest(`${pluginsFolder}/swiper`)),
...
function cssTask() {
  return src('src/scss/style.scss')
    ...
    .pipe(filter(['**', `!${distCSS}style.css.min.map`])) // ignore minified sourcemap
    .pipe(dest(distCSS))
}
